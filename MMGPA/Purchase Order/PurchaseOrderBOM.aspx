    ...
    <form id="form1" runat="server">
                ...
                <div class="justify-content-end d-flex px-0 text-body-secondary mb-0 mt-4">
                    <div class="col-md-6 px-0">
                        <div class="fw-semibold fs-3 text-dark">
                            <asp:Literal ID="Literal14" Text="Upload P.O. BOM" runat="server"></asp:Literal>
                        </div>
                    </div>
                        ...
                        <div id="searchGridDiv" visible="false" runat="server" class="mt-3">
                            ...
                            <asp:GridView ShowHeaderWhenEmpty="true" ID="gridSearch" runat="server" AutoGenerateColumns="false" OnRowCommand="gridSearch_RowCommand" AllowPaging="true" PageSize="10"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PoRegNo" HeaderText="P.O. Registration No." ItemStyle-CssClass="col-xs-3 align-middle text-start fw-light" />
                                    ...
                                    <asp:BoundField DataField="POBomCount" HeaderText="P.O. BOM Count" ItemStyle-CssClass="col-xs-3 align-middle text-start fw-light" />
        ...
        <div id="UpdateDiv" runat="server" visible="false">
            ...
            <div class="col-md-12 mx-auto fw-normal fs-3 fw-medium ps-0 pb-2 text-dark-emphasis mt-1 mb-1">
                <asp:Literal Text="Upload P.O. BOM" runat="server"></asp:Literal>
            </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-12 align-self-end">
                            <div class="mb-1 text-body-tertiary fw-semibold fs-6">
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="rr1" ControlToValidate="PoNo" ValidationGroup="finalSubmit" CssClass="invalid-feedback" InitialValue="0" runat="server" ErrorMessage="select p.o. number" SetFocusOnError="True" Display="Dynamic" ToolTip="Required"></asp:RequiredFieldValidator>
                                </div>
                            </div>
