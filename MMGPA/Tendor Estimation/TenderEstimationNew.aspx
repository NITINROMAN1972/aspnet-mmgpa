<%@ Page Language="C#" UnobtrusiveValidationMode="None" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="TenderEstimationNew.aspx.cs" Inherits="Tendor_BOM_TendorBOM" %>
                            ...
                            <div id="excelUploadDiv" runat="server" visible="false" class="mb-3 mt-3 py-3">
                                ...
                                <div class="border-top border-bottom border-secondary-subtle py-2 mt-4">
                                    <div class="fw-normal fs-5 fw-medium text-body-secondary">
                                        <asp:Literal Text="Upload Estimate Items Excel" runat="server"></asp:Literal>
                                    </div>
                                </div>
